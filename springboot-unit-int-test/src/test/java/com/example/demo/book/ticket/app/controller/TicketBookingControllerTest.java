package com.example.demo.book.ticket.app.controller;
...
import com.example.demo.book.ticket.app.service.TicketBookingService;
...
public class TicketBookingControllerTest {
	...
	public void testGetTicketById() throws Exception {
		...
		Optional<Ticket> opt = Optional.of(mockTicket);
		
		Mockito.when(ticketBookingService.getTicketById(Mockito.anyInt())).thenReturn(opt);
