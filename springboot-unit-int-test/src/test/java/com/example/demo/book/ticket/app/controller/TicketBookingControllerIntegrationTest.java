...
import com.example.demo.SpringbootUnitIntTestApplication;
import com.example.demo.book.ticket.app.entities.Ticket;
import com.fasterxml.jackson.core.JsonProcessingException;
import com.fasterxml.jackson.databind.ObjectMapper;

@RunWith(SpringRunner.class)
@SpringBootTest(classes = SpringbootUnitIntTestApplication.class, webEnvironment = SpringBootTest.WebEnvironment.RANDOM_PORT)
