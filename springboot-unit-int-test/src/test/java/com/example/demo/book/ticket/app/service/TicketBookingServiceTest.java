package com.example.demo.book.ticket.app.service;
...
import com.example.demo.book.ticket.app.dao.TicketBookingDao;
...
public class TicketBookingServiceTest {
	...
	public void testGetTicketById(){
		...
		ticket.setBookingDate(new Date());
		ticket.setEmail("martin.s2017@gmail.com");
		Optional<Ticket> opt = Optional.of(ticket);
	    Mockito.when(ticketBookingDao.findById(1)).thenReturn(opt);
	    assertThat(ticketBookingService.getTicketById(1)).isEqualTo(opt);
	}
	...
	public void testUpdateTicket(){
		...
		assertThat(ticketBookingService.updateTicket(1, "martin.s2017@gmail.com")).isEqualTo(opt);
